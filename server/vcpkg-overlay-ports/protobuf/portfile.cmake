...
if(VCPKG_DOWNLOAD_MODE)
    # Download PKGCONFIG in download mode; vcpkg_cmake_configure() exits early.
...
# Apple clang searches /usr/local/include by default. Force the vcpkg include tree to
# the front so bundled Homebrew headers (notably absl/utf8-range) cannot leak into the
# protobuf port build and create ABI mismatches against the vcpkg static libraries.
set(protobuf_vcpkg_include_flag "-I${CURRENT_INSTALLED_DIR}/include")

vcpkg_cmake_configure(
    SOURCE_PATH "${SOURCE_PATH}"
    OPTIONS
        -DCMAKE_CXX_STANDARD=17
        -DCMAKE_C_FLAGS=${protobuf_vcpkg_include_flag}
        -DCMAKE_CXX_FLAGS=${protobuf_vcpkg_include_flag}
